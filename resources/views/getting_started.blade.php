...
<div class="container">
    ...
    <div class="row" id="gsRow">
            ...
            <div class="col col-md-6 mt-auto mb-auto"><img class="img-fluid" data-aos="fade-left" src="assets/img/GS2.jpg"></div>
    </div>
    ...
    <div class="row" id="gsRow">
        ...
        <div class="row" id="gsRow">
            ...
            <div class="col col-md-6 mt-auto mb-auto"><img class="img-fluid" data-aos="fade-right" src="assets/img/Checklist.jpg"></div>
        </div>
