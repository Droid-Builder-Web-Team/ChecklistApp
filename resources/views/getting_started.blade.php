...
<div class="container">
    <div class="row sec1" id="gsRow">
        <div class="col col-12 col-md-12 text-center background">
    ...
    <div class="row">
        <div class="col col-md-12">
            <div class="hero" data-aos="zoom-in" data-aos-delay="1000">
    ...
    <div class="row sec2" id="gsRow2">
        <div class="col col-12 col-md-6 text-center mt-auto mb-auto"><img class="img-fluid" data-aos="fade-right" data-aos-delay="500" src="assets/img/DroidMainframe.jpg"></div>
        <div class="col col-12 col-md-6 text-center mt-auto mb-auto">
    ...
    <div class="row" id="gsRow3">
            ...
            <div class="col col-12 col-md-6 mt-auto mb-auto"><img class="img-fluid" data-aos-delay="500" data-aos="fade-left" src="assets/img/GS2.jpg">
            </div>
            <div class="mx-auto">
                <div class="col col-md-12">
                    <div class="hero" data-aos="zoom-in" data-aos-delay="1000">
    ...
    <div class="row" id="gsRow4">
        <div class="col col-12 col-md-12 text-center mt-auto mb-auto">
        ...
        <div class="row" id="gsRow5">
            <div class="col col-12 col-md-6 text-center mt-auto mb-auto"><img class="img-fluid" id="infoImg" data-aos="fade-right" data-aos-delay="500" src="assets/img/GS4.jpg"></div>
            <div class="col col-12 col-md-6 text-center mt-auto mb-auto">
                <h1 class="gsHeading p-2" data-aos="fade-left" data-aos-delay="100">Droid information</h1>
                <h3 class="gssubText p-2" data-aos="fade-left" data-aos-delay="300">it's always great to have key information about your droid to hand. in this section you can easily create a back story for your droid, giving it a designation, description, colours as well as going into detail on control system, electronics
        ...
        <div class="row" id="gsRow6">
            ...
            <div class="col col-md-6 text-center mt-auto mb-auto"><img class="img-fluid" data-aos-delay="500" data-aos="fade-right" src="assets/img/Checklist.jpg">
            </div>
            <div class="mx-auto">
                <div class="col col-md-12">
                    <div class="hero" data-aos="zoom-in" data-aos-delay="1000">
        ...
        <div class="row" id="gsRow7">
            <div class="col col-12 col-md-12 mt-auto mb-auto">
        ...
        <div class="row" id="gsRow8">
            <div class="col col-12 col-md-6 mt-auto mb-auto"><img class="img-fluid" data-aos-delay="500" data-aos="fade-right" src="assets/img/Profile.jpg" style="height:500px;"></div>
            <div class="col col-12 col-md-6 mt-auto mb-auto">
        ...
        <div class="row" id="gsRow9">
            <div class="col col-12 col-md-12 mx-auto text-center">
